defmodule PhoenixKitCalendar.ActivityLogAssertions do
  @moduledoc """
  Helpers for asserting activity log entries landed with the right
  action, module, and metadata shape.

  Imported into `PhoenixKitCalendar.DataCase` and
  `PhoenixKitCalendar.LiveCase` so every DB-backed test can reach
  them.
  """
  ...
  ## Example
      ...
      assert_activity_logged("calendar.demo_event",
